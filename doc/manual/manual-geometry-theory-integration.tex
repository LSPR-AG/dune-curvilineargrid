...
The integration in \textit{dune-curvilineargrid} focuses on two additional questions:
\begin{itemize}
...
\noindent
To address the first question, \textit{dune-curvilineargrid} implements a polynomial class, which is stored as a sum of monomials of a given order. Integrals over monomials of a given order can be expressed analytically \textbf{[REF\_ABSTRACT]} \\
