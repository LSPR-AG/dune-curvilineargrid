...
\usepackage{amsmath, esint}			%% Equations
\usepackage{amssymb}				%% Additional symbols
\usepackage{graphicx}				%% Main package for figure inclusion
...
%\usepackage{array}
\usepackage{algorithm,algorithmic}		%% Allows [H] option for figures for exact placement
\usepackage{tikz}
...
%\usepackage{wrapfig}
%\usepackage{makeidx}
\usepackage{listings}					%% Interface for code typing
\usepackage{color}					%% Allows color generation
\usepackage{xcolor}					%% Allows color generation
%\usepackage{enumitem}
%\usepackage[normalem]{ulem}
\usepackage{mathtools}				%% Declare mathematical operators, e.g. \DeclarePairedDelimiter, e.g.  inner product
\usepackage{lscape}					%% Allow landscape pages
%\usepackage{url}
\usepackage{hyperref}					%% Allow URL's and active links within the document
%\usepackage[nameinlink]{cleveref}		%% Allows referencing subfigures. Must be loaded after hyperref
\usepackage{cleveref}					%% Allows referencing subfigures. Must be loaded after hyperref
...
%\newcommand{\myboxsrc}[1]{%
% \newenvironment{\myboxsrc}
% 	{%
% 		%\setbox0=\hbox{#1}%
% 		%\setlength{\@tempdima}{\dimexpr\wd0+13pt}%
% 		\begin{tcolorbox}[colframe=mycolor,boxrule=0.5pt,arc=4pt, left=6pt,right=6pt,top=6pt,bottom=6pt,boxsep=0pt,width=\@tempdima] %#1
% 	}
% 	{
% 		\end{tcolorbox}
% 	}
%-----------------------------------------------
\usepackage{lipsum}
%\newenvironment{mybox}{\textbf{startlolo}\\}{\textit{finishlolo}\\}
\newenvironment{mybox}{\vspace{2mm} \begin{tcolorbox}[colframe=mycolor, left=1pt,right=4pt,top=2pt,bottom=2pt]}{\end{tcolorbox} \vspace{1mm}}



%\newenvironment{mybox}{\myboxsrc}{}
%\def\myboxsrc#1\end{\emph{#1}\end}
...
%innerrightmargin=4pt,innertopmargin=5pt,innerbottommargin=5pt]{mybox}
