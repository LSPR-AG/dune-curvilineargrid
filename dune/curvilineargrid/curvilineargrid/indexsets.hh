    ...
    public:
      ...
      CurvIndexSet (GridBaseType & gridbase)
          : gridbase_(gridbase),
      	    geomtypes_
      	    {
  		      std::vector<GeometryType> (1, GeometryType ( GeometryTypes::simplex(3).id(), 3)),
  		      std::vector<GeometryType> (1, GeometryType ( GeometryTypes::simplex(3).id(), 2)),
  		      std::vector<GeometryType> (1, GeometryType ( GeometryTypes::simplex(3).id(), 1)),
  		      std::vector<GeometryType> (1, GeometryType ( GeometryTypes::simplex(3).id(), 0))
      	    }
      {
